...
public partial class VwWorkOrderHsecondition
{
    ...
    public string HseconditionsName { get; set; } = null!;

    public string? HseconditionsForeignName { get; set; }

    public string? HseconditionsRemark { get; set; }

    public bool HseconditionsIsActive { get; set; }
